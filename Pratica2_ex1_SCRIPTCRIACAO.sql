...
CREATE TABLE L02_CIDADE
  (
    NOME      NUMBER NOT NULL ,DROP TABLE L08_Partido;
DROP TABLE L10_Cargo;
DROP TABLE L12_Pesquisa;
DROP TABLE L01_Estado;
DROP TABLE L09_Candidato;
...
CREATE TABLE L02_CIDADE
  ...
  ;
CREATE or replace INDEX CIDADE_FKINDEX1 ON L02_CIDADE
  (
    SGLESTADO ASC
  )
  ;
...
CREATE TABLE L03_ZONA
  ...
  ;
CREATE or replace INDEX L03_ZONA_FKINDEX1 ON L03_ZONA
  (
    NOMECIDADE ASC
  )
  ;
...
CREATE TABLE L05_URNA
  ...
  ;
CREATE or replace INDEX L05_URNA_FKINDEX1 ON L05_URNA
  (
    NROZONA ASC
  )
  ;
...
CREATE TABLE L06_SESSAO
  ...
  ;
CREATE or replace INDEX L06_SESSAO_FKINDEX1 ON L06_SESSAO
  (
    NROZONA ASC
  )
  ;
CREATE or replace INDEX L06_SESSAO_FKINDEX2 ON L06_SESSAO
  (
    NSERIAL ASC
  )
  ;
...
CREATE TABLE L07_PLEITO
  (
    ...
    L02_CIDADE_NOME   NUMBER NOT NULL ,
    ANO               NUMBER ,
    TOTALDECANDIDATOS NUMBER DEFAULT 0
  )
  ;
CREATE or replace INDEX L07_PLEITO_FKINDEX1 ON L07_PLEITO
  (
    L02_CIDADE_NOME ASC
  )
  ;
...
CREATE or replace INDEX L09_CANDIDATO_FKINDEX1 ON L09_CANDIDATO
  (
    SGLPARTIDO ASC
  )
  ;
...
CREATE TABLE L11_CANDIDATURA
  ...
  ;
CREATE or replace INDEX L11_CANDIDATURA_FKINDEX1 ON L11_CANDIDATURA
  (
    NROCANDIDATO ASC
  )
  ;
CREATE or replace INDEX L11_CANDIDATURA_FKINDEX2 ON L11_CANDIDATURA
  (
    CODCARGO ASC
  )
  ;
...
CREATE TABLE L15_COMPUTAINTENCAOVOTOS
  ...
  ;
CREATE or replace INDEX IFK_REL_18 ON L15_COMPUTAINTENCAOVOTOS
  (
    REGPESQUISA ASC
  )
  ;
CREATE or replace INDEX IFK_REL_19 ON L15_COMPUTAINTENCAOVOTOS
  (
    REGCANDIDATURA ASC
  )
  ;

ALTER TABLE L15_COMPUTAINTENCAOVOTOS ADD CONSTRAINT L15_COMPTNTVOTOS_L11_CAND_FK FOREIGN KEY ( REGCANDIDATURA ) REFERENCES L11_CANDIDATURA ( REG ) NOT DEFERRABLE ;

ALTER TABLE L09_CANDIDATO ADD CONSTRAINT SYS_C007715 FOREIGN KEY ( SGLPARTIDO ) REFERENCES L08_PARTIDO ( SIGLA ) NOT DEFERRABLE ;

ALTER TABLE L02_CIDADE ADD CONSTRAINT SYS_C007719 FOREIGN KEY ( SGLESTADO ) REFERENCES L01_ESTADO ( SIGLA ) NOT DEFERRABLE ;

ALTER TABLE L07_PLEITO ADD CONSTRAINT SYS_C007723 FOREIGN KEY ( L02_CIDADE_NOME ) REFERENCES L02_CIDADE ( NOME ) NOT DEFERRABLE ;

ALTER TABLE L11_CANDIDATURA ADD CONSTRAINT SYS_C007728 FOREIGN KEY ( NROCANDIDATO ) REFERENCES L09_CANDIDATO ( NRO ) NOT DEFERRABLE ;

ALTER TABLE L11_CANDIDATURA ADD CONSTRAINT SYS_C007729 FOREIGN KEY ( CODCARGO ) REFERENCES L10_CARGO ( COD ) NOT DEFERRABLE ;

ALTER TABLE L03_ZONA ADD CONSTRAINT SYS_C007733 FOREIGN KEY ( NOMECIDADE ) REFERENCES L02_CIDADE ( NOME ) NOT DEFERRABLE ;

ALTER TABLE L05_URNA ADD CONSTRAINT SYS_C007737 FOREIGN KEY ( NROZONA ) REFERENCES L03_ZONA ( NROZONA ) NOT DEFERRABLE ;

ALTER TABLE L15_COMPUTAINTENCAOVOTOS ADD CONSTRAINT SYS_C007745 FOREIGN KEY ( REGPESQUISA ) REFERENCES L12_PESQUISA ( REGPESQUISA ) NOT DEFERRABLE ;

ALTER TABLE L06_SESSAO ADD CONSTRAINT SYS_C007757 FOREIGN KEY ( NROZONA ) REFERENCES L03_ZONA ( NROZONA ) NOT DEFERRABLE ;

ALTER TABLE L06_SESSAO ADD CONSTRAINT SYS_C007758 FOREIGN KEY ( NSERIAL ) REFERENCES L05_URNA ( NSERIAL ) NOT DEFERRABLE ;

ALTER TABLE L13_PLEITOCANDIDATURA ADD CONSTRAINT SYS_C007783 FOREIGN KEY ( CODPLEITO ) REFERENCES L07_PLEITO ( CODPLEITO ) NOT DEFERRABLE ;

ALTER TABLE L13_PLEITOCANDIDATURA ADD CONSTRAINT SYS_C007784 FOREIGN KEY ( REGCANDIDATO ) REFERENCES L11_CANDIDATURA ( REG ) NOT DEFERRABLE ;

ALTER TABLE L04_BAIRRO ADD CONSTRAINT SYS_C007789 FOREIGN KEY ( NOMECIDADE ) REFERENCES L02_CIDADE ( NOME ) NOT DEFERRABLE ;

ALTER TABLE L04_BAIRRO ADD CONSTRAINT SYS_C007790 FOREIGN KEY ( NROZONA ) REFERENCES L03_ZONA ( NROZONA ) NOT DEFERRABLE ;

ALTER TABLE L14_COMPUTAVOTOS ADD CONSTRAINT SYS_C007794 FOREIGN KEY ( SESSAONRO ) REFERENCES L06_SESSAO ( SESSAONRO ) NOT DEFERRABLE ;

ALTER TABLE L14_COMPUTAVOTOS ADD CONSTRAINT SYS_C007795 FOREIGN KEY ( REGCANDIDATURA ) REFERENCES L11_CANDIDATURA ( REG ) NOT DEFERRABLE ;

ALTER TABLE L14_COMPUTAVOTOS ADD CONSTRAINT SYS_C007796 FOREIGN KEY ( CODPLEITO ) REFERENCES L07_PLEITO ( CODPLEITO ) NOT DEFERRABLE ;
